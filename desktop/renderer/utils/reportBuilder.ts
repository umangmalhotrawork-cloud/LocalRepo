...
<head>
  ...
  <title>NEXUS Causal Engineering Report: ${escapeHtml(projectName)}</title>
  <style>
    body {
      margin: 0;
      padding: 40px 24px;
...
<body>
  <div class="container">
    ...
    <!-- Footer -->
    <div class="footer">
      Generated by NEXUS · Causal Tomography & Safe Code Surgery Suite · Offline Self-Contained Report
    </div>
