...
import IDEApp from "../renderer/IDEApp";
...
export default function DesktopPage() {
  ...
  useEffect(() => {
    console.log("[DESKTOP-PAGE] Client mounted. Initializing IDEApp...");
    setMounted(true);
  }, []);
  ...
  if (!mounted) {
    return (
      <div className="w-screen h-screen bg-[#050505] text-cyan-400 flex flex-col items-center justify-center font-mono text-sm gap-3">
        ...
        <span className="text-xs text-zinc-500">Mounting Monaco Editor & Python AST Engine...</span>
      </div>
    );
  }
